...
CFLAGS_ALL += -D_XOPEN_SOURCE=700 -D_MUSL_ $(if $(CERTIKOS),-D_CERTIKOS_,) -I$(srcdir)/arch/$(ARCH) -I$(srcdir)/arch/generic -Iobj/src/internal -I$(srcdir)/src/include -I$(srcdir)/src/internal -Iobj/include -I$(srcdir)/include -I$(srcdir)/ringleader/include
