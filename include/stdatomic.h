#ifndef _USER_STDATOMIC_H_
#define _USER_STDATOMIC_H_
...
#define atomic_compare_exchange_val_strong(PTR, VAL, DES)   \
  ({                                                        \
    __auto_type _ptr = (PTR);                               \
    __typeof__(* _ptr) _val = (VAL);                        \
    atomic_compare_exchange_strong(PTR, &_val, DES);        \
    _val;                                                   \
  })
